...
* @Last Modified time: 2019-09-22 22:07:38
*/
...
function generate_squares_about()
{
	...
	html += gen_square_about('r',75, 105, 0.4, 575, 67, 1, false);
	...
	html += gen_square_about('r',265, 153, 0.5, 705, 229, 1, false);
	html += gen_square_about('b',56, 55, 0.25, 607, 290, 1, false);
	html += gen_square_about('b',62, 62, 0.25, 806, 274, 1, false);
	html += gen_square_about('r',182, 132, 0.25, 898, 179, 1, false);
	...
	html += gen_square_about('r',183, 125, 0.25, 912, 472, 1, false);
	...
	html += gen_square_about('b',140, 103, 0.25, 1008, 733, 1, false);
	html += gen_square_about('r',64, 64, 0.25, 1108, 841, 1, false);
	html += gen_square_about('p',162, 93, 0.5, 844, 842, 1, false);
	...
	html += gen_square_about('b',219, 128, 0.4, 1074, 950, 1, false);
	html += gen_square_about('r',36, 39, 0.25, 822, 1018, 1, false);
	...
	html += gen_square_about('r',87, 127, 0.4, 1061, 1237, 1, false);
	...
	html += gen_square_about('r',45, 45, 0.4, 1249, 1301, 1, false);
...
function generate_squares_top()
{
	...
	html += gen_square_top('r',81, 19, 0.4, 15, 560, 1, false);
	...
	html += gen_square_top('p',35, 35, 0.5, 133, 758, 1, false);
	...
	html += gen_square_top('p',242, 91, 0.5, 77, 905, 1, false);
	html += gen_square_top('p',50, 24, 0.25, 0, 1073, 1, false);
	html += gen_square_top('b',140, 92, 0.4, 41, 1037, 1, false);
	html += gen_square_top('r',191, 111, 0.25, 0, 1109, 1, false);
	html += gen_square_top('p',78, 112, 0.25, 77, 1288, 1, false);
	html += gen_square_top('b',45, 45, 0.5, 214, 1187, 1, false);
	...
	html += gen_square_top('r',45, 45, 0.4, 302, 1310, 1, false);
